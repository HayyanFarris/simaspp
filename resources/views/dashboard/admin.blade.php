...
<div class="space-y-6" x-data="{
    ...
    <div class="bg-white rounded-lg shadow">
        <div class="flex items-center justify-between px-6 py-3 border-b cursor-pointer"
            ...
            <h2 class="text-lg font-semibold text-gray-800">📋 Rekap Status Pembayaran</h2>
        ...
        <div x-show="rekapOpen" x-transition.duration.300ms class="p-6">
            ...
            <div class="flex flex-wrap items-center justify-between mb-4">
                <form method="GET" action="{{ route('dashboard.admin') }}" x-data="{ form: $el }"
                    @change="form.submit()" class="flex flex-wrap items-center gap-3">
                    <div>
