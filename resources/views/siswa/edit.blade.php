    ...
    <div class="max-w-2xl p-6 bg-white rounded-lg shadow-md">
        <form action="{{ route('siswa.update', $siswa) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="number" name="nominal_spp" id="nominal_spp"
                    value="{{ old('nominal_spp', $siswa->nominal_spp) }}" step="0.01"
            ...
            <div class="mb-4">
                ...
                <input type="text" name="no_telepon_orang_tua" id="no_telepon_orang_tua"
                    value="{{ old('no_telepon_orang_tua', $siswa->no_telepon_orang_tua) }}"
