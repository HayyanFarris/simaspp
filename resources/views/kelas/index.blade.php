        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase">Nama
                        Kelas</th>
                    <th class="px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase">Tingkat
                    </th>
                    <th class="px-6 py-3 text-xs font-medium tracking-wider text-left text-gray-500 uppercase">Wali
                        Kelas</th>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 text-sm text-gray-900 whitespace-nowrap">{{ $item->nama_kelas }}</td>
                    <td class="px-6 py-4 text-sm text-gray-900 whitespace-nowrap">{{ $item->tingkat }}</td>
                    ...
                    <td class="px-4 py-2 text-center border">
                        ...
                        <!-- Tombol Hapus -->
                        <form action="{{ route('kelas.destroy', $item) }}" method="POST" class="inline-block"
